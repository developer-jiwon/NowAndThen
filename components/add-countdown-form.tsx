                    ...
                    <div className="relative w-full">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="h-8 w-full max-w-[320px] pl-9 pr-3 rounded-md border border-input bg-background text-base focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                          min="1900-01-01"
                          max="2100-12-31"
                        />
                      </div>
